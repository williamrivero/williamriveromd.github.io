...
ALT_TEXT = {
    ...
    "nephron-anatomy-3d.png": "Nephron anatomy — 3D rendering of tubular segments from Bowman capsule to collecting duct",
    "glomerular-barrier-3d.png": "Glomerular filtration barrier — 3D cross-section of podocyte foot processes and GBM",
    "glomerular-filtration-barrier-2d.png": "Glomerular filtration barrier — 2D schematic of endothelium, GBM and podocyte slit diaphragm",
