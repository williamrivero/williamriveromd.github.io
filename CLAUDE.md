...
`.spotlight-thumb` cards). It is regenerated by `generate_latest_guides.py` (newest publish
time first) — do not hand-edit the block; `latest_guides.json` is written alongside as the
ordered data.
