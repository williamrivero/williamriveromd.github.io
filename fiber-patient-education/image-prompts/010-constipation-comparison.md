IMAGE NUMBER: 010
SECTION PLACEMENT: Section 8 — "Special Situations" — Constipation subsection, above the
three alert boxes (prunes / prune juice / melon milk)
FILE NAME: fiber-patient-education-constipation-comparison-infographic.png
...
- 2D infographic: 50% — verdict labels, gram callouts, bold yes/no/partial stamps
- 3D component graphics: 50% — photorealistic food renders of prunes, juice glass, melon drink
PURPOSE: Answer the three most common constipation questions in one image. Patients
regularly ask about prune juice and melon milk as constipation remedies — this image
shows clearly which one works, which one partially works, and which one does not work.
KEY CONCEPTS: Prunes = dual mechanism (fiber + sorbitol); prune juice = sorbitol only,
not a fiber source; melon milk = no fiber, no evidence for constipation relief.
